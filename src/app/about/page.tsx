				...
				<div className="flex w-full max-w-[1200px] px-5 py-10 items-center flex-col md:flex-row">
					...
					<div className="flex w-12/12 md:w-6/12 flex-col mt-[50px] md:mt-0 relative">
						<div className="flex flex-col">
							<span className="text-4xl text-base-black">Esther Regina</span>
						</div>
					...
					<div className="flex mt-7 w-full flex-wrap">
                            ...
                            <div className="flex m-4 border border-base-burnished-brown rounded-lg w-full justify-center flex-col">
                                <div className="flex items-center w-full border-b border-b-base-burnished-brown h-[65px] px-5 justify-center">
                                    ...
                                    <div className="flex py-5 flex-col">
                                        <div className="flex">
                                            <span className="text-lg font-medium">Inkubator IT</span>
                                        </div>
                                        <div className="flex">
                                            <span className="text-xs">Your IT-Based Solution</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex py-4 flex-col h-full">
                                    <div className="flex w-full justify-center">
                                        <span className="font-semibold text-sm text-center">Marketing Staff (2023-2024)</span>
                                    </div>
                        ...
                        <div className="flex w-full md:w-6/12">
                            <div className="flex m-4 border border-base-burnished-brown rounded-lg w-full justify-center flex-col">
                                ...
                                <div className="flex py-4 flex-col h-full">
                                    <div className="flex w-full justify-center">
                                        <span className="font-semibold text-sm text-center">Officials Staff and Intern (2023-present)</span>
                                    </div>
                                    <div className="flex justify-start items-end mt-3 px-5 flex-col">
                                        <span className="text-center">Coordinated and tracked progress across mechanical, electrical, and programming divisions using Trello.</span>
                                    </div>
                                </div>
                                <div className="flex h-[65px] border-t border-t-base-burnished-brown px-5">
                                    <div className="flex w-full border-r border-r-base-burnished-brown py-5">
                        ...
                        <div className="flex w-full md:w-6/12">
                            <div className="flex m-4 border border-base-burnished-brown rounded-lg w-full justify-center flex-col">
                                ...
                                <div className="flex h-full py-4 flex-col">
                                    <div className="flex w-full justify-center">
                                        <span className="font-semibold text-sm text-center">Culture Intern and Staff (2022-2023)</span>
                                    </div>
                                    <div className="flex justify-start items-end mt-3 px-5 flex-col">
                                        <span className="text-center">Supervised other divisions to ensure regular and effective division meetings were conducted, maintaining organizational efficiency and communication</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex w-full md:w-6/12">
                            <div className="flex m-4 border border-base-burnished-brown rounded-lg w-full justify-center flex-col">
                                ...
                                <div className="flex h-full py-4 flex-col">
                                    <div className="flex w-full justify-center">
                                        <span className="font-semibold text-sm text-center">Organizational Intelligence Manager (2021)</span>
                                    </div>
                                    <div className="flex justify-start mt-3 px-5 flex-col">
                                        <span className="text-center">Developed Organization’s Website to ensure a better awareness and engagement, resulting increased in partnership</span>
                                    </div>
                                </div>
                                <div className="flex h-[65px] border-t border-t-base-burnished-brown px-5">
                                    <div className="flex w-full border-r border-r-base-burnished-brown py-5">
					...
					<div className="flex mt-7 w-full flex-col">
                        ...
                        <div className="flex my-3 border border-base-parrot-pink rounded-lg w-full flex-col">
                            <div className="flex p-4 border-b border-b-base-burnished-brown w-full">
                                <span className="font-medium">1st place of IDSC International Company Case Competition 2023 by Airlangga University</span>
                            </div>
                            ...
                            <div className="flex border-t border-t-base-burnished-brown items-center">
                                ...
                                <div className="flex w-10/12 p-4">
                                    <span className="font-semibold text-xs">Problem Solving, Critical Thinking, Presentation Skills, Communication Skills</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex my-3 border border-base-parrot-pink rounded-lg w-full flex-col">
                            <div className="flex p-4 border-b border-b-base-burnished-brown w-full">
                                <span className="font-medium"> 2nd place of IAF Business Case Competition 2023 by IPB University</span>
                            </div>
                            <div className="flex flex-col p-4 text-xs">
                                <div className="flex my-2">
                                    <li>
                        ...
                        <div className="flex my-3 border border-base-parrot-pink rounded-lg w-full flex-col">
                            <div className="flex p-4 border-b border-b-base-burnished-brown w-full">
                                <span className="font-medium">Best Social Project Team in Digistar Class 2023 by PT Telkom</span>
                            </div>
                            <div className="flex flex-col p-4 text-xs">
                                <div className="flex my-2">
                                    <li>
